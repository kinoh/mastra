...
var require_js_tokens = chunkEMMSS5I5_cjs.__commonJS({
...
async function saveInlineSnapshots(environment, snapshots) {
  const MagicString = (await import('./magic-string.es-NBXOXRCK.cjs')).default;
...
//# sourceMappingURL=dist-6ZEQKKXY.cjs.map
//# sourceMappingURL=dist-6ZEQKKXY.cjs.map