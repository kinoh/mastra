...
async function getInputOptions2(entryFile, platform, env, { sourcemap = false, transpilePackages = [] } = {}) {
  ...
  if (transpilePackages.length) {
    const { output, reverseVirtualReferenceMap } = await chunk7T2PU7VS_cjs.bundleExternals(
  ...
  if (Array.isArray(inputOptions.plugins)) {
    ...
    inputOptions.plugins.push(chunk7T2PU7VS_cjs.aliasHono());
...
function removeAllOptionsExceptServer(result) {
  return chunk7T2PU7VS_cjs.removeAllOptionsFromMastraExcept(result, "server");
}
...
//# sourceMappingURL=chunk-J4CNHLNI.cjs.map
//# sourceMappingURL=chunk-J4CNHLNI.cjs.map